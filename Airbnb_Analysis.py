...
st.set_page_config(page_title="AirBnb-Analysis by GURU SABARI!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir(r"D:\Program Files\Visual Studio\New folder")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"GURU SABARI S"}')
    mail = (f'{"Mail :"}  {"sggurusabari@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        "GITHUB": "https://github.com/gurusabari",
        "LINKEDIN": "https://www.linkedin.com/in/guru-sabari-saiganesh/"}

    col1, col2 = st.columns(2)
    col1.image(Image.open("D:\\Program Files\\Visual Studio\\New folder\\Guru_Sabari.JPG"), width=300)
